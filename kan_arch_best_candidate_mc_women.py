...
dataset = Path("", "kan_training_dataset_women", "d2b89e14-cf6a-448a-a288-5a344fa95a45")
...
model0 = {"width": [input_size, input_size * 2, int(input_size / 4), 2],
          "grid": 5,
          "k": 5}
model1 = {"width": [input_size, input_size * 2 + 10, int(input_size / 4), 2],
          "grid": 5,
          "k": 3}
model2 = {"width": [input_size, input_size * 2 + 10, int(input_size / 4) + 10, 2],
          "grid": 5,
          "k": 3}
model3 = {"width": [input_size, input_size * 2, int(input_size / 4) + 10, 2],
          "grid": 5,
          "k": 3}
model4 = {"width": [input_size, input_size * 2, int(input_size / 4), 2],
          "grid": 7,
          "k": 3}
model5 = {"width": [input_size, input_size * 2, int(input_size / 4), 2],
          "grid": 9,
          "k": 3}
model6 = {"width": [input_size, input_size * 2, int(input_size / 4), 2],
          "grid": 9,
          "k": 5}
