...
results_path = Path(".", "results_mc_kan_search_best_candidate_blade1", dataset)
# get the number of features
input_size = X.shape[1]
# define KAN architecture


model0 = {"width": [input_size, int(input_size * 2 + 10), 2],
          "grid": 10,
          "k": 3}
model1 = {"width": [input_size, int(input_size * 2 + 10), 2],
          "grid": 20,
          "k": 3}
model2 = {"width": [input_size, int(input_size * 2 + 10), 2],
          "grid": 10,
          "k": 5}
